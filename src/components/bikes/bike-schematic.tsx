...
const ROAD_POSITIONS: Record<string, { left: number; top: number }> = {
  saddle:         { left: 30, top: 10 },
  dropper_post:   { left: 34, top: 28 },
  handlebar_tape: { left: 76, top: 12 },
  headset:        { left: 63, top: 20 },
  cables:         { left: 50, top: 15 },
  fork:           { left: 74, top: 45 },
  brake_pads:     { left: 70, top: 55 },
  brake_rotors:   { left: 80, top: 60 },
  tires_front:    { left: 90, top: 80 },
  tires_rear:     { left: 6, top: 80 },
  wheels_front:   { left: 85, top: 45 },
  wheels_rear:    { left: 10, top: 45 },
  chain:          { left: 28, top: 65 },
  cassette:       { left: 15, top: 58 },
  bottom_bracket: { left: 36, top: 72 },
  pedals:         { left: 42, top: 82 },
